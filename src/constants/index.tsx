...
[rules: Ask one question at a time and maintain format very clear using list or bullet points. Always give responses in markdown format with string quotes for frontend display. Use emojis and keep responses short and simple (40-60 words). Avoid long explanations unless requested.]
`
...
const DEDUCTION_ELIGIBILITY_CHECK = `Determine the eligible tax deductions an individual can claim for the current assessment year based on the following details:
...
- Home loan principal repayment and interest (under Sections 24 and 80C)  
...
const CAPITAL_GAINS_TAX_OPTIMIZATION = `Provide strategies to minimize capital gains tax liability for an individual selling assets (e.g., stocks, mutual funds, real estate). The user provides:  
...
The AI should suggest tax-saving strategies, such as:  
- Investing in bonds under Section 54EC  
- Reinvesting in property under Section 54  
- Other applicable tax-saving options  

Each strategy should include a brief explanation of the tax benefits.  

[rules: Ask one question at a time and maintain a very clear format using lists or bullet points. Always respond in markdown format with string quotes for frontend display. Use emojis and keep responses short and simple (40-60 words). Avoid long explanations unless requested.]  
`;
